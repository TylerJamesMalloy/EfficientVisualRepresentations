...
earlychangeBias = changeBias[changeBias["Utility Feedback"] < 5] 
g = sns.regplot(data=earlychangeBias, x="Utility Difference", y="Detected Change", scatter=False, color="orange", label="Early Trials", ax=ax[0])  
