...
if __name__ == '__main__':
    ...
    modelAversionColumns = ["Id", "Model", "Split", "Log Likelihood", "Beta", "Upsilon"]
    modelAversion = pd.DataFrame([], columns=modelAversionColumns)
    ...
    for idx, id in enumerate(ids):        
        ...
        #modelAversionColumns = ["Id", "Model", "Split", "Log Likelihood", "Coefficient"]
        d = pd.DataFrame([[id, "UBVAE", 100, best_nll, beta_coef, upsilon_coef]], columns=modelAversionColumns)
        modelAversion = pd.concat([d, modelAversion])
        ...
        upsilon_coef = coefs[np.argmin(results)][0]
        #modelAversionColumns = ["Id", "Model", "Split", "Log Likelihood", "Coefficient"]
        d = pd.DataFrame([[id, "UBVAE 80", 80, test_nll, beta_coef, upsilon_coef]], columns=modelAversionColumns)
        modelAversion = pd.concat([d, modelAversion])
        ...
        upsilon_coef = coefs[np.argmin(results)][0]
        #modelAversionColumns = ["Id", "Model", "Split", "Log Likelihood", "Coefficient"]
        d = pd.DataFrame([[id, "UBVAE 60", 60, test_nll, beta_coef, upsilon_coef]], columns=modelAversionColumns)
        modelAversion = pd.concat([d, modelAversion])
        ...
        upsilon_coef = coefs[np.argmin(results)][0]
        #modelAversionColumns = ["Id", "Model", "Split", "Log Likelihood", "Coefficient"]
        d = pd.DataFrame([[id, "UBVAE 40", 40, test_nll, beta_coef, upsilon_coef]], columns=modelAversionColumns)
        modelAversion = pd.concat([d, modelAversion])


    modelAversion = modelAversion.reset_index()
    modelAversion.to_pickle("./modelAversion.pkl")

    modelAversion = pd.read_pickle("./modelAversion.pkl")
    modelAversion["Log Likelihood"] = -1 * modelAversion["Log Likelihood"] 

    # ANOVA
    result = stats.f_oneway(modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE"],
                            modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE 80"],
                            modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE 60"],
                            modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE 40"])
    print(result)

    res = stats.tukey_hsd(modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE"],
                            modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE 80"],
                            modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE 60"],
                            modelAversion['Log Likelihood'][modelAversion['Model'] == "UBVAE 40"])
    print(res)
